...
<br>
<br>
<form  method="post" name="login" action="Update" style="max-width:500px;margin:auto" >
  
  <h1 align="center" style="color:black;">Update a Job</h1>
  <p>Job name</p>
  <div class="input-container">
    <input type="text" class="input-field empty" id="iconified" placeholder="&#xf0b1           Type job id " onfocusout="pvalid()" name="ct"/>
